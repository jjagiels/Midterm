...
public abstract class Person {
	...
	public int PrintAge() throws PersonException {
		...
		if (age > 100){
			throw new PersonException("You appear to be unreasonably old.");
		}
	...
	public void PhoneNumberChecker() throws PersonException{
		...
		if (doesMatch == false){
			throw new PersonException("Your phone number was formatted incorrectly.");
		}
